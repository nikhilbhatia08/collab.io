        ...
        <table class="min-w-fit leading-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-slate-500 text-sm">
                    <div class="mt-8">
                        <button class="bg-green-500 text-white font-bold py-2 px-4 w-48 rounded hover:bg-green-400" type='submit'>Accept</button>
                    </div>
                    <div class="mt-8">
                        <button class="bg-red-500 text-white font-bold py-2 px-4 w-48 rounded hover:bg-red-400" type='submit'>Regect</button>
                    </div>
              </td>
            </tr> 
                )

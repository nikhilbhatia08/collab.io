  ...
  <nav class="mt-6 relative max-w-7xl w-full  mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto " aria-label="Global">
    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
      <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
        ...
        <Link class="font-medium text-gray-500 hover:text-gray-400 md:py-6 " to='/account'>Account</Link>
        <Link class="font-medium text-gray-500 hover:text-gray-400 md:py-6 " to='/work' >Work</Link>
        ...
        {user ? (<div class="text-white">Welcome user</div>) : (<Link to='/login' class="flex items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 md:border-l md:border-gray-300 md:my-6 md:pl-6  border-gray-700  text-gray-400  hover:text-blue-500" >

            ...
            {projects.map((project)=>{
                ...
                <div className="flex-col border-b">
                    <div className="flex flex-wrap items-center">
                        <div className="inline-block"><img className="h-16 w-16 rounded-full my-10" src={require('../pictures/picofdev.png')} alt="" /></div>
                        <div className="my-4 inline-block"><p className="mx-5 inline-block lg:text-3xl md:text-base sm:text-xs text-white">Name/Title of the project</p></div>

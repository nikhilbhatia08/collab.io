      ...
      <div class="grid h-[800px] gap-8 overflow-auto lg:grid-cols-1">
        {arr.map((node)=>{
          ...
          <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
              ...
              <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 "><a href="#">Best practices for successful prototypes</a></h2>
              <p class="mb-5 font-light text-gray-500 ">Flowbite is an open-source library of UI components built with the utility-first classes from Tailwind CSS. It also includes interactive elements such as dropdowns, modals, datepickers.</p>
              <div class="flex justify-between items-center">
                  ...
                  <Link to='Readblog' class="inline-flex items-center font-medium text-primary-600  hover:underline">
                      Read more

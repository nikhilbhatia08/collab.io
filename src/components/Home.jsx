...
<div class="bg-slate-900">
  <div class="bg-gradient-to-b from-violet-600/[.19] via-transparent">
    <div class="max-w-[85rem] mx-5 px-4 sm:px-4 lg:px-8 py-14 space-y-8">
      <div class="ml-28 max-w-5xl flex justify-between">
        <h1 class=" block font-medium text-white text-5xl mr-28 pr-28 sm:text-5xl md:text-6xl lg:text-7xl">
          Welcome to Collab.io the best way to showcase your projects.
        </h1>
        
        <img className="get_img  w-0 sm:w-0 md:w-32 lg:w-48 ml-16 pl-26" src={require('../pictures/problem.png')} alt="" />
      </div>

      <div class="max-w-3xl mr-28 text-center mx-auto">
        <p class="text-lg text-gray-400">Showcase your project and get hired by top companies</p>
      </div>
      <div className="ml-28">
      <div class="ml-28 justify-center text-center">
        <Link to='/getstarted' class="ml-10 inline-flex items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 shadow-lg shadow-transparent hover:shadow-blue-700/50 border border-transparent text-white text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white py-3 px-6  focus:ring-offset-gray-800" >
          Get started
    ...
    <Link to='GetFreelance' class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all  hover:bg-white/[.075]" href="#">
      ...
      <div>
        <div>
          ...
          <p class=" text-gray-400">Click here to embark on an exhilarating journey into the realm of freelance opportunities.</p>
        </div>

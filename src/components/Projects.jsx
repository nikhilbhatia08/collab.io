            ...
            {projects ? (projects.map((project)=>{
                ...
                <div className="flex-col border-b">
                    <div className="flex flex-wrap items-center">
                        ...
                        <div className="my-4 inline-block"><Link to={`/projects/${project.id_p}`}><p className="mx-5 inline-block hover:text-blue-500 lg:text-3xl md:text-base sm:text-xs text-white">{project.title}</p></Link></div>

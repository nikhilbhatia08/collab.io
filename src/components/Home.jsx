...
<div className="max-w-[100rem] px-4 sm:px-6 lg:px-8  mx-auto">
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-3 xl:gap-6">
    <Link  to={user ? `/projects/Addproj/${user._doc.id_p}` : `/login`} className="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all  hover:bg-white/[.075]" href="#">
